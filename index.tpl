          ...
          <aside id="notes" class="my-8">
            <ul class="my-3 flex-list gap-4">
              <li class="mr-auto text-bold text-lg opacity">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="title-color">
              ...
              <li onclick="action('like')" class="action-button like">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="accent-color">
              ...
              <li class="action-button reblog">
                <a href="{ReblogURL}">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="accent-color">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path
              ...
              <li onclick="action('follow')" class="action-button follow">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="accent-color">
                  <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                  <path
